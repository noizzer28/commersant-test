...
React + TypeScript приложение для отображения списка постов с пагинацией и страницей отдельного поста.  
...
UPD:
Проба внедрить cursor ai в разработку, добавлена сортировка постов, ветка ai-helpers-test
